...
\begin{document}
    ...
    \textit{\marker{\textbf{Instrucciones.}} Esta tarea es \textbf{individual} y deberá ser entregada \textbf{presencialmente} el día \textbf{25 de septiembre} durante la clase.}\vspace{.3cm}
