...
\begin{document}
    ...
    \textit{\marker{\textbf{Instrucciones.}} Esta tarea es \textbf{individual} y deberá ser entregada \textbf{presencialmente} el día \textbf{23 de octubre} durante la clase.}\vspace{.3cm}
