...
\begin{document}
    ...
    \begin{center}
        {\fontsize{30}{60}\rmfamily \textbf{Tarea 7}} \\ \vspace{.2cm}
    ...
    \textit{\marker{\textbf{Instrucciones.}} Esta tarea es \textbf{individual} y deberá ser entregada \textbf{presencialmente} el día \textbf{20 de noviembre} durante la clase.}\vspace{.3cm}
